...
<!-- <h1 class="section-h2"><?=$arResult["NAME"]?></h1> -->
...
<?}?>
	...
	<div class="price-block">
		<span class="price">
			Цена: <span <?if($arItem["PROPERTIES"]["OLD_PRICE"]["VALUE"]):?> data-old-price="<?=$arItem["PROPERTIES"]["OLD_PRICE"]["VALUE"]?> р." <?endif;?>><?=$arItem["PRICES"]["Розничные"]["PRINT_VALUE"]?></span>
		</span>
		<span class="article">
