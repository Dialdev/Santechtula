...
<!--
	<h2 class="h2 h2-min"><a href="/sale/">Товары по акции</a></h2>
	<a href="/sale/" class="learnmore learnmore_catalog learnmore_index-sale">Посмотреть все товары по акции</a>
		<?
			GLOBAL $arFilter;
			$arFilter = array(
			'PROPERTY_34' => 17,
		...
		?>
		<?$APPLICATION->IncludeComponent("bitrix:catalog.top", "index-sale", array(
