...
<div id="basket_items_list">
	...
	<br>
	<div class="delivery-dop">
		<span class="delivery-dop__btn"><b>Подробнее об условиях оплаты и доставки</b></span>
		<div class="delivery-dop__hide">
			<br><h3 class="h3_dostavka"><span style="color: #b60606;">Условия доставки.</span></h3>
			<p>
	...
	<div class="bx_ordercart_order_pay">
		...
		<div class="buy-block">
			<span class="info">
				<span>*</span> Нажимая кнопку «Оформить заказ», я подтверждаю свою дееспособность, согласие на получение информации об оформлении и получении заказа, согласие на обработку персональных данных в соответствии с указанным здесь текстом.
			</span>
			<!-- <a href="/catalog/" class="return">Продолжить покупки</a> -->
