...
<div class="bx_filter_horizontal bx_<?=$arParams["TEMPLATE_THEME"]?>">
	<div class="bx_filter_section m4">
		<div class="bx_filter_title">Фильтровать<?/*echo GetMessage("CT_BCSF_FILTER_TITLE")*/?></div>
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<?foreach($arResult["ITEMS"] as $key=>$arItem):
				...
				// print_r($arItem);
					...
					<?
					if (!$arItem["VALUES"]["MIN"]["VALUE"] || !$arItem["VALUES"]["MAX"]["VALUE"] || $arItem["VALUES"]["MIN"]["VALUE"] == $arItem["VALUES"]["MAX"]["VALUE"] || $arItem["ID"]!=="1")
						continue;
					?>
			...
			<?foreach($arResult["ITEMS"] as $key=>$arItem):?>
				...
				<div class="bx_filter_prop">
					<span class="bx_filter_prop_name"><?=$arItem["NAME"]?></span>
					<div class="bx_filter_container poz<?echo $arItem["ID"]?>">
						<span class="bx_filter_container_title" onclick="hideFilterProps(this)"><span class="bx_filter_container_modef">Выберите <?=$arItem["NAME"]?></span></span>
						<div class="bx_filter_block">
							<?foreach($arItem["VALUES"] as $val => $ar):?>
							<span class="filter-block__item <?echo $ar["DISABLED"] ? 'disabled': ''?>">
								<div class="checkbox">
									<input
										type="checkbox"
									...
									/>
									<span class="check" onclick="smartFilter.click(this)"><i></i></span>
