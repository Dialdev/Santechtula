...
else
{
	...
	?>
			...
			<?if ($bPrevDisabled):?><span class="disabled">назад</span><?else:?><a href="<?=$sPrevHref;?>" id="<?=$ClientID?>_previous_page">назад</a><?endif;?>	
	<?
	$bFirst = true;
	$bPoints = false;
	do
...
?>
<?/*if ($bNextDisabled):?><span class="disabled">вперед</span><?else:?><a href="<?=$sNextHref;?>" id="<?=$ClientID?>_next_page">вперед</a><?endif;*/?>
